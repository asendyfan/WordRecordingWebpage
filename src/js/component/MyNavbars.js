...
export default class MyNavbars extends React.Component{
    render(){
        return (
            <nav className="navbar navbar-expand-lg navbar-dark" style={{backgroundColor:'#001529'}}>
                ...
                <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
                        <li className="nav-item active dropdown">
                            ...
                            <div className="dropdown-menu">
                                <Link to="/WordRecords" className="dropdown-item nav-link text-dark ml-2">生词记录</Link>
                                <Link to="/WordRecords" className="dropdown-item nav-link text-dark ml-2">排列组合计算</Link>
                            </div>
                        </li>
                    ...
                    <div className=" my-2 my-lg-0 mr-5 text-white">
