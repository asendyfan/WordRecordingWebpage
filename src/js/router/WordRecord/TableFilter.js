...
class TableFilter extends React.Component{
    ...
    render(){
        ...
        return <div className='page-max-width container mb-1 mt-5 mx-sm-0'>
            <div className='row'>
                <div className='col-12 col-sm-6 col-md-4 px-0'>
                    ...
                    <div>
                        <Select defaultValue='所有' onChange={(value)=>this.typeSelectChange(value)}>
                            <Select.Option value='所有'>所有</Select.Option>
                            {classifications.map(value=><Select.Option value={value}>{value}</Select.Option>)}
                        </Select>
                    </div>
                </div>
            </div>
